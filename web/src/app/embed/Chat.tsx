...
import { FiPlusSquare, FiSend, FiStopCircle } from "react-icons/fi";
...
import { FeedbackModal } from "../chat/modal/FeedbackModal";
import { DocumentSidebar } from "../chat/documentSidebar/DocumentSidebar";
import { Persona } from "../admin/personas/interfaces";
import { ChatPersonaSelector } from "../chat/ChatPersonaSelector";
import { useFilters } from "@/lib/hooks";
import { DocumentSet, Tag, ValidSources } from "@/lib/types";
import { ChatFilters } from "../chat/modifiers/ChatFilters";
import { buildFilters } from "@/lib/search/utils";
import { SelectedDocuments } from "../chat/modifiers/SelectedDocuments";
  ...
  const onSubmit = async ({
    ...
    if (isNewSession) {
      ...
      if (
        ...
        router.push(`/embed?chatId=${currChatSessionId}`, {
          scroll: false,
        });
      }
    }
